               ...
               <div class="col-lg-8">
                  <div class="xzoom-container">
                     <img
                        ...
                        id="xzoom-magnific"
                        src="{{ asset('assets/themes/deepblue/img/product/product-1.jpg') }}"
                        xoriginal="{{ asset('assets/themes/deepblue/img/product/product-1.jpg') }}"
                     />
                     <div class="xzoom-thumbs d-flex owl-carousel">
                        <a href="{{ asset('assets/themes/deepblue/img/product/product-1.jpg') }}"
                           ><img
                              class="xzoom-gallery5 img-fluid"
                              width=""
                              src="{{ asset('assets/themes/deepblue/img/product/product-1.jpg') }}"
                              xpreview="{{ asset('assets/themes/deepblue/img/product/product-1.jpg') }}"
                              title="The description goes here"
                        /></a>
                        <a href="{{ asset('assets/themes/deepblue/img/product/product-2.jpg') }}"
                           ><img
                              class="xzoom-gallery5 img-fluid"
                              width=""
                              src="{{ asset('assets/themes/deepblue/img/product/product-2.jpg') }}"
                              title="The description goes here"
                        /></a>
                        <a href="{{ asset('assets/themes/deepblue/img/product/product-3.jpg') }}"
                           ><img
                              class="xzoom-gallery5 img-fluid"
                              width=""
                              src="{{ asset('assets/themes/deepblue/img/product/product-3.jpg') }}"
                              title="The description goes here"
                        /></a>
                        <a href="{{ asset('assets/themes/deepblue/img/product/product-4.jpg') }}"
                           ><img
                              class="xzoom-gallery5 img-fluid"
                              width=""
                              src="{{ asset('assets/themes/deepblue/img/product/product-4.jpg') }}"
                              title="The description goes here"
                        /></a>
                        <a href="{{ asset('assets/themes/deepblue/img/product/product-4.jpg') }}"
                           ><img
                  ...
                  <div class="side-bar">
                     <div class="side-box">
                        ...
                        <div class="creator-box">
                           <div class="img-box">
                              <img
                                 src="{{ asset('assets/themes/deepblue/img/pexels-darya-sannikova-2422386.jpg') }}"
                                 alt=""
                           ...
                           <div class="text-box">
                              ...
                              <a href="{{ route('profile') }}" class="btn-custom"
                                 >Visit profile</a
                              >
                           </div>
                        </div>
