                ...
                <div class="col-xl-6">
                    <div class="wrapper d-flex justify-content-center justify-content-xl-start  wow fadeInLeft"
                        ...
                        <div class="d-flex position-relative">
                            <div class="about-fig">
                                <img class="w-100"src="{{getFile(config('location.content.path').@$aboutUs->templateMedia()->image)}}" alt="Image Missing" class="w-100">
                            </div>
                            <div class="about-overlay-fig">
                                <img class="w-100"class="img-fill w-100" src="{{getFile(config('location.content.path').@$aboutUs->templateMedia()->image)}}" alt="Image Missing" >
                            </div>
                        </div>
                    </div>
                </div>
