                    ...
                    @forelse($Packages as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Name')">
                                @lang(@$item->details->title)
                            </td>

                            <td data-label="@lang('Price')">
                                <span class="badge badge-secondary">{{ @$item->price }} {{ @$basic->currency ?? 'USD' }}</span>
                            </td>
                            ...
                            <td data-label="@lang('Action')">
                                <button class="btn btn-sm btn-primary edit-button" type="button">
                                    <a href="{{ route('admin.packageEdit',$item->id) }}" class="text-white">
                                        <i class="fa fa-edit" aria-hidden="true"></i> @lang('Edit')
                                    </a>
                                </button>

                                <a href="javascript:void(0)"
                                    data-route="{{ route('admin.packageDelete', $item->id) }}"
                                    data-toggle="modal"
