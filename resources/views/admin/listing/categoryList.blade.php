    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="media mb-4 float-right">
                <a href="{{route('admin.listingCategoryCreate')}}" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tbody>
                    @forelse($listingCategory as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                <button class="btn btn-sm btn-primary edit-button" type="button">
                                    <a href="{{ route('admin.listingCategoryEdit',$item->id) }}" class="text-white">
                                        <i class="fa fa-edit" aria-hidden="true"></i> @lang('Edit')
                                    </a>
                                </button>

                                <a href="javascript:void(0)"
                                    data-route="{{ route('admin.listingCategoryDelete', $item->id) }}"
                                    data-toggle="modal"
