...
<?php if(isset($contentDetails['feature'])): ?>
    <!-- FEATURE -->
    <section style="padding: 120px 0"id="feature">
                    ...
                    <?php $__currentLoopData = $contentDetails['feature']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card-type-1 card wow fadeInUp" data-wow-duration="1s" data-wow-dealy="0.1s">
                                <div class="card-icon">
                                    <img class="w-100"class="card-img-top w-100" src="<?php echo e(getFile(config('location.content.path').@$feature->content->contentMedia->description->image)); ?>" alt="....">
                                </div>
                                <div class="card-body">
    ...
    <!-- /FEATURE -->
<?php endif; ?>
<?php /**PATH D:\server\htdocs\project\resources\views/themes/deepblue/sections/feature.blade.php ENDPATH**/ ?>