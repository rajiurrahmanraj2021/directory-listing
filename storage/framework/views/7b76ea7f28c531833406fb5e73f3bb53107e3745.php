...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Blog Category List'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="media mb-4 float-right">
                <a href="<?php echo e(route('admin.blogCategoryCreate')); ?>" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $manageBlogCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                <button class="btn btn-sm btn-primary edit-button" type="button">
                                    <a href="<?php echo e(route('admin.blogCategoryEdit',$item->id)); ?>" class="text-white">
                                        <i class="fa fa-edit" aria-hidden="true"></i> <?php echo app('translator')->get('Edit'); ?>
                                    </a>
                                </button>

                                <a href="javascript:void(0)"
                                    data-route="<?php echo e(route('admin.blogCategoryDelete', $item->id)); ?>"
                                    data-toggle="modal"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\directory-listing\resources\views/admin/blog/categoryList.blade.php ENDPATH**/ ?>