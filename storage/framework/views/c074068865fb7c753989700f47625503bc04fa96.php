...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Edit Blog'); ?>
            ...
            <div class="tab-content mt-2" id="myTabContent">
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="lang-tab-<?php echo e($key); ?>" role="tabpanel">
                        <form method="post" action="<?php echo e(route('admin.blogUpdate',[$id, $language->id])); ?>" class="mt-4" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                            <?php $__empty_1 = true; $__currentLoopData = $blogCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($item->details->blog_category_id); ?>" <?php echo e($item->details->blog_category_id == $blogDetails[$language->id][0]->blog->blog_category_id ? 'selected' : ''); ?>><?php echo app('translator')->get($item->details->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="details[<?php echo e($language->id); ?>]" id="summernote" rows="15" value="<?php echo old('author'.$language->id, isset($blogDetails[$language->id]) ? @$blogDetails[$language->id][0]->details : '') ?>"><?php echo old('author'.$language->id, isset($blogDetails[$language->id]) ? @$blogDetails[$language->id][0]->details : '') ?></textarea>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="image-input ">
                                                ...
                                                src="<?php echo e(getFile(config('location.blog.path').(isset($blogDetails[$language->id]) ? @$blogDetails[$language->id][0]->blog->image : ''))); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\directory-listing\resources\views/admin/blog/blogEdit.blade.php ENDPATH**/ ?>