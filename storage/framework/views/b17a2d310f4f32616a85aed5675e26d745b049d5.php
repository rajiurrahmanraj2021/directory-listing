        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo e(route('admin.blogList')); ?>" class="sidebar-link">
                                <span class="hide-menu"><?php echo app('translator')->get('Blog Create'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i class="fas fa-clipboard-list"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('Listing'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a href="<?php echo e(route('admin.listingCategory')); ?>" class="sidebar-link">
...
<?php /**PATH D:\server\htdocs\project\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>