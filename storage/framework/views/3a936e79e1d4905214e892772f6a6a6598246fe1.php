    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="media mb-4 float-right">
                <a href="<?php echo e(route('admin.blogCreate')); ?>" class="btn btn-sm btn-primary mr-2">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Category'); ?>">
                                <?php echo app('translator')->get(optional(optional($blog->category)->details)->name); ?>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Category'); ?>">
                                <?php echo app('translator')->get(@$blog->details->author); ?>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\directory-listing\resources\views/admin/blog/blogList.blade.php ENDPATH**/ ?>