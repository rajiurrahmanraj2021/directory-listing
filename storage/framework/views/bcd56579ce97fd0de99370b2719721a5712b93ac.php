                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $Packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Name'); ?>">
                                <?php echo app('translator')->get(@$item->details->title); ?>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Price'); ?>">
                                <span class="badge badge-secondary"><?php echo e(@$item->price); ?> <?php echo e(@$basic->currency ?? 'USD'); ?></span>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Expiry Time'); ?>">
                                <?php if(@$item->expiry_time == Null): ?>
                                    
                                    <span class="badge badge-success"><?php echo app('translator')->get('Unlimited'); ?></span>
                                <?php else: ?>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                <button class="btn btn-sm btn-primary edit-button" type="button">
                                    <a href="<?php echo e(route('admin.packageEdit',$item->id)); ?>" class="text-white">
                                        <i class="fa fa-edit" aria-hidden="true"></i> <?php echo app('translator')->get('Edit'); ?>
                                    </a>
                                </button>

                                <a href="javascript:void(0)"
                                    data-route="<?php echo e(route('admin.packageDelete', $item->id)); ?>"
                                    data-toggle="modal"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\project\resources\views/admin/package/index.blade.php ENDPATH**/ ?>