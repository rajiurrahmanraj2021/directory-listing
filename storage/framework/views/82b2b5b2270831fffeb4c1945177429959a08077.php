...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo old('icon'.$language->id, isset($listingCategoryDetails[$language->id]) ? @$listingCategoryDetails[$language->id][0]->category->icon : '') ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\project\resources\views/admin/listing/listingCategoryEdit.blade.php ENDPATH**/ ?>