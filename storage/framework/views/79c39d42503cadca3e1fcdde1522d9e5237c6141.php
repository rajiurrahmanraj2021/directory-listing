                    ...
                    <div class="col-md-6 col-lg-4">
                        <a class="card-blog card wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.15s"
                           href="<?php echo e(route('blogDetails',[slug(@$data->description->title), $data->content_id])); ?>">
                            ...
                            <h5 class="h5 mt-5 mb-5"><?php echo e(\Str::limit(@$data->description->title,40)); ?></h5>
                            <p class="text">
...
<?php /**PATH D:\server\htdocs\project\resources\views/themes/deepblue/sections/blog.blade.php ENDPATH**/ ?>