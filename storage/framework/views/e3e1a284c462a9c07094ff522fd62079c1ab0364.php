          ...
          <div class="col-md-6 col-lg-3 ps-lg-5">
             <div class="footer-box">
                ...
                <ul>
                   ...
                   <li>
                      <a href="<?php echo e(route('pricing')); ?>"><?php echo app('translator')->get('Pricing'); ?></a>
                   </li>
                   <li>
                      <a href="<?php echo e(route('listing')); ?>"><?php echo app('translator')->get('Listing'); ?></a>
                   </li>
                   <li>
                      <a href="<?php echo e(route('blog')); ?>"><?php echo app('translator')->get('Blogs'); ?></a>
                   </li>
                   <li>
...
<?php /**PATH C:\xampp\htdocs\directory-listing\resources\views/themes/deepblue/partials/footer.blade.php ENDPATH**/ ?>