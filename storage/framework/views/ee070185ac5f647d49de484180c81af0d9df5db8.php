...
<html class="no-js" lang="en" <?php if(session()->get('rtl') == 1): ?> dir="rtl" <?php endif; ?> >
    ...
    <body>
        ...
        <!-- magnific popup -->
        <script src="<?php echo e(asset('assets/themes/deepblue/assets/plugins/magnific-popup/magnific-popup.js')); ?>"></script>
        <!-- xzoom -->
        <script src="<?php echo e(asset('assets/themes/deepblue/assets/plugins/xZoom/xzoom.min.js')); ?>"></script>
