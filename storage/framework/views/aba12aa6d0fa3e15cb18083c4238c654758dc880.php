...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div
                                    ...
                                    <a class=" mt-10"  href="<?php echo e(route('password.request')); ?>"><?php echo app('translator')->get("Forgot password?"); ?></a>
                                </div>

                                <div class="btn-area">
                                    <button class="btn btn-primary" type="submit"><span><?php echo app('translator')->get('Login'); ?></span></button>
                                </div>
