...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p class="text-dark text-left mt-4"><span class="text-danger"><?php echo app('translator')->get('NB'); ?>:</span> <?php echo app('translator')->get('After changing Banner, clear your browser cache to see changes'); ?></p>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\directory-listing\resources\views/admin/banner.blade.php ENDPATH**/ ?>