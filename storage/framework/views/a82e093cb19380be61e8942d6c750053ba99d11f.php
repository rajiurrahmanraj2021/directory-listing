            ...
            <div class="<?php echo e((session()->get('rtl') == 1) ? 'carousel-payment-rtl': 'carousel-payment'); ?>  owl-carousel owl-theme">
                ...
                <div class="item-carousel">
                    <div class="payment-fig">
                        <img class="w-25"src="<?php echo e(getFile(config('location.gateway.path').@$gateway->image)); ?>" alt="<?php echo e(@$gateway->name); ?>" >
                    </div>
                </div>
...
<!-- /PAYMENT-METHOD -->
<?php /**PATH D:\server\htdocs\project\resources\views/themes/deepblue/sections/we-accept.blade.php ENDPATH**/ ?>